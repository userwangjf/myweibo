    ...
    public void onWidgetClick(View view) {
        switch (view.getId()) {
            case R.id.btn_short_snackbar:
                TSnackbarUtils.with(snackBarRootView)
            ...
            case R.id.btn_long_snackbar:
                TSnackbarUtils.with(snackBarRootView)
                        ...
                        .setMessageColor(Color.WHITE)
                        .setDuration(TSnackbarUtils.LENGTH_LONG)
                        .setBgResource(R.drawable.shape_top_round_rect)
                        .show();
                break;
            ...
            case R.id.btn_indefinite_snackbar:
                TSnackbarUtils.with(snackBarRootView)
                        ...
                        .setMessageColor(Color.WHITE)
                        .setDuration(TSnackbarUtils.LENGTH_INDEFINITE)
                        .setBgResource(R.drawable.shape_top_round_rect)
                        .show();
                break;
            ...
            case R.id.btn_add_view:
                ...
                TSnackbarUtils.with(snackBarRootView)
                        ...
                        .setDuration(TSnackbarUtils.LENGTH_INDEFINITE)
                        .show();
                TSnackbarUtils.addView(R.layout.snackbar_custom, params);
                break;
            ...
            case R.id.btn_add_view_with_action:
                ...
                TSnackbarUtils.addView(R.layout.snackbar_custom, params);
                View snackbarView = TSnackbarUtils.getView();
...
public final class TSnackbarUtils {
    ...
    private static WeakReference<TSnackbar> sReference;
    ...
    private TSnackbarUtils(final View parent) {
        setDefault();
        this.parent = parent;
    }
     ...
     * @return {@link TSnackbarUtils}
     */
    public static TSnackbarUtils with(@NonNull final View parent) {
        return new TSnackbarUtils(parent);
    }
     ...
     * @return {@link TSnackbarUtils}
     */
    public TSnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return {@link TSnackbarUtils}
     */
    public TSnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return {@link TSnackbarUtils}
     */
    public TSnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return {@link TSnackbarUtils}
     */
    public TSnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return {@link TSnackbarUtils}
     */
    public TSnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return {@link TSnackbarUtils}
     */
    public TSnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public TSnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
    ...
    public void show() {
        ...
        if (messageColor != COLOR_DEFAULT) {
            ...
            sReference = new WeakReference<>(TSnackbar.make(view, spannableString, duration));
        } else {
            sReference = new WeakReference<>(TSnackbar.make(view, message, duration));
        }
        final TSnackbar snackbar = sReference.get();
    ...
    public static View getView() {
        TSnackbar snackbar = sReference.get();
    ...
    public static void addView(@LayoutRes final int layoutId,
        ...
        if (view != null) {
            ...
            TSnackbar.SnackbarLayout layout = (TSnackbar.SnackbarLayout) view;
